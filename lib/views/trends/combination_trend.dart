...
class CombinationTrend extends StatefulWidget {
  @override
  createState() => new _CombinationTrendState();
}

class _CombinationTrendState extends State<CombinationTrend> {
          ...
          itemBuilder: (context, i) {
            ...
            return new Column(
              children: <Widget>[
                ...
                new Container(
                  child: new Text("质合比:" + sizeProportion(item),
                    style: new TextStyle(
                        fontSize: 16.0
                    ),
                  ),
