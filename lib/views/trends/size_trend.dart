...
class SizeTrend extends StatefulWidget {
  @override
  createState() => new _SizeTrendState();
}

class _SizeTrendState extends State<SizeTrend> {
          ...
          itemBuilder: (context, i) {
            ...
            return new Column(
              children: <Widget>[
                ...
                new Container(
                  child: new Text("大小比:" + sizeProportion(item),
                    style: new TextStyle(
                        fontSize: 16.0
                    ),
                  ),
